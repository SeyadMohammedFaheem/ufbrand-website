        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {['Suits', 'Kurtis', 'Sarees', 'Journal'].map(link => (
                <li key={link}>
                  <Link
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div>
                <p className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 mb-1">WhatsApp Support</p>
                <a href="https://wa.me/918122404928" className="text-[13px] font-medium text-zinc-600 hover:text-[#D4147A] transition-colors">
                  +91 8122404928
                </a>
              </div>
              <div>
